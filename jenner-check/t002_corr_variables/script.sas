...
/* Correlation des variables explicatives avec la variable a expliquer */
proc corr data=projet_mpg;
  title 'Correlation des variables explicatives avec la variable a expliquer';
