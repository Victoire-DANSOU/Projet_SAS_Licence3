...
/* Quartiles pour la detection des valeurs aberrantes */
proc means data=projet_mpg n q1 q3;
  var poids acceleration cylindres puissance deplacement;
run;

/* Suppression des valeurs aberrantes (bornes de Tukey) */
data mpg_clean;
  set projet_mpg;
